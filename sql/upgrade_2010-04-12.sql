ALTER TABLE `accounts` ADD `email_opt_out` ENUM( "Y", "N" ) NOT NULL DEFAULT 'N' AFTER `fax` ;
ALTER TABLE `accounts` ADD `do_not_call` ENUM( "Y", "N" ) NOT NULL DEFAULT 'N' AFTER `email_opt_out` ;
