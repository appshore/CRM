...
ALTER TABLE `searches` ADD `is_default` ENUM("Y","N") NOT NULL DEFAULT 'N' AFTER `search_name`;

DELETE FROM `db_blocks` WHERE `app_name` = 'preferences_searches';
...
DELETE FROM `db_fields` WHERE `app_name` = 'preferences_searches';
...
('preferences_searches', 'searches', 'created', 'N', 'N', 'TS', 'Created', 1, '0000-00-00 00:00:00', '', '', '', '', 'N', 'Y', 'N', 'N', 'Y', 0, 4, 'grid_center', 0, 'L', '', 1, 'L', 'ya81xno8534wcc48cwkscwsw', 0, 'L', '', 0, 0, 1, 'L', '155stu4q1dr4kck004s808ko8', 0, 'L', '', 4),
...
('preferences_searches', 'searches', 'is_default', 'N', 'N', 'CH', 'Default search', 1, 'Y', '', '', '', '', 'N', 'N', 'N', 'N', 'Y', 3, 3, 'grid_center', 0, 'L', '', 2, 'L', '785ofb87iz8c4s80o4kkw44g', 2, 'L', '1gd2edpui5wgcow8cscwss84k', 0, 0, 0, 'R', '109qf1yjq6u8g8w8csc4kck0', 1, 'R', '1yc2lqbfqav4s80wgwsc40wcs', 3),
...
('preferences_searches', 'searches', 'search_name', 'N', 'N', 'VF', 'Search filter name', 1, '', '', '', '', '', 'Y', 'N', 'N', 'N', 'Y', 2, 2, 'grid_left', 0, 'L', '', 1, 'L', '15mmys2jk6lcc448k4c4oscw4', 1, 'L', 'dqulv1sqb14cscwko8gco404', 0, 0, 1, 'L', 'bpk76wid1r4gscocw840k00', 1, 'L', '15pe5y7kwg4gos88s808c8sc8', 2),
('preferences_searches', 'searches', 'updated', 'N', 'N', 'TS', 'Updated', 1, '0000-00-00 00:00:00', '', '', '', '', 'N', 'Y', 'N', 'N', 'Y', 0, 5, 'grid_center', 0, 'L', '', 1, 'R', 'ya81xno8534wcc48cwkscwsw', 0, 'L', '', 0, 0, 1, 'R', '155stu4q1dr4kck004s808ko8', 0, 'L', '', 5),
