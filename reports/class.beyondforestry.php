...
class reports_beyondforestry extends reports_parameter_popup
{

    function __construct()
    {
    	parent::__construct();
        $GLOBALS['appshore']->add_xsl('reports.beyondforestry');
    } 
	...
	function start_popup()
    {
		...
		$args['col_uc'] = 'A.start_date'; //nor update, nor create (see in preprocess of range_nucdate(u/c) 
