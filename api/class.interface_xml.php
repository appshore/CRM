...
class api_interface_xml
{
	...
	function handle_result($result)
	{
		if( $result )
		{
			$GLOBALS['xml_api']->AttachToXml( $result, 'API');
			echo $GLOBALS['xml_api']->Render( false, DOMi::RENDER_XML);
		}	
	}
	...
	function ping()
	{
		...
		$GLOBALS['xml_api']->AttachToXml(PRIVATE_LABEL.$company['company_alias'], 'ping');
	}	
