...
$bmh->verbose            = VERBOSE_DEBUG; //VERBOSE_REPORT; //VERBOSE_DEBUG; //VERBOSE_QUIET; // default is VERBOSE_SIMPLE
$bmh->use_fetchstructure = false; // true is default, no need to speficy
...
//default
$bmh->mailhost           = 'server6.appshore.com'; // your mail server
$bmh->mailbox_username   = 'bounced'; // your mailbox username
$bmh->mailbox_password   = 'matahari'; // your mailbox password

//gmail
#$bmh->mailhost           = 'imap.gmail.com';//'server6.appshore.com'; // your mail server
#$bmh->mailbox_username   = 'mailer@appshore.net';//'bounced'; // your mailbox username
#$bmh->mailbox_password   = 'australia2006';//'matahari'; // your mailbox password
#$bmh->port               = 993;//110; // the port to access your mailbox, default is 143
...
//$bmh->service            = 'pop3'; // the service to use (imap (143) or pop3 (110)), default is 'imap'
