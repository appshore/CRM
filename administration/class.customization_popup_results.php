...
class administration_customization_popup_results extends administration_customization_applications{
	
    function __construct()
    {
        parent::__construct();    	

	    $this->form_name 			= 'popup_results';
	    $this->field_sequence		= 'popup_result_sequence';
