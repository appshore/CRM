	...
	class PHPReportGroup {
		...
		*/
		function getValue($sField_) {
			if(is_null($this->_oFields[$sField_])) 
				new PHPReportsError("You're trying to retrieve the value of a field called <b>$sField_</b>, but its not on your SQL query. Please check your query.<br/><br/>".$this->listFields(),"missingfield.php?field=$sField_");
		...
		*/
		function getSum($sField_) {
			if(is_null($this->_oFields[$sField_]))
				new PHPReportsError("You're trying to retrieve the SUM of a field called <b>$sField_</b>, but its not on your SQL query. Please check your query.","missingfield.php?field=$sField_");
		...
		*/
		function getMax($sField_) {
			if(is_null($this->_oFields[$sField_]))
				new PHPReportsError("You're trying to retrieve the MAX of a field called <b>$sField_</b>, but its not on your SQL query. Please check your query.","missingfield.php?field=$sField_");
		...
		*/
		function getMin($sField_) {
			if(is_null($this->_oFields[$sField_]))
				new PHPReportsError("You're trying to retrieve the MIN of a field called <b>$sField_</b>, but its not on your SQL query. Please check your query.","missingfield.php?field=$sField_");
		...
		*/
		function getAvg($sField_) {
			if(is_null($this->_oFields[$sField_]))
				new PHPReportsError("You're trying to retrieve the AVG of a field called <b>$sField_</b>, but its not on your SQL query. Please check your query.","missingfield.php?field=$sField_");
