...
$GLOBALS['appshore_interface'] = 'xml';

if( !isset( $_SERVER ) )
{
	echo "<api><status>error</status><error><code>ERROR_INVALID_DOMAIN_NAME</code><message>Invalid domain name</message></error></api>";
	exit();
}
...
{
	echo "<api><status>error</status><error><code>ERROR_PERMISSION_DENIED</code><message>You do not have access right on this application</message></error></api>";
	exit();
}	
